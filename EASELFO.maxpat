...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"co_in_polarity" : [ 0 ],
						"co_kb" : [ 0 ],
						"co_pitch" : [ 63.146728515625 ],
						"co_pitch_att" : [ 126 ],
						"co_pitch_cv_select" : [ 2 ],
						"co_timbre" : [ 0 ],
						"co_timbre_att" : [ 10 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "control.gendsp",
				"bootpath" : "~/Desktop/EASELFO/patchers",
				"patcherrelativepath" : "../../../EASELFO/patchers",
				"type" : "gDSP",
				"implicit" : 1
			}
, 			{
